...
All CSV data files and supporting code used in this analysis, as well as the paper in .pdf format, are publicly available in the [currently open repository.](https://github.com/bcosm/2024_election_betting_market_microstructure_analysis)
...
Overall, it is clear that no single group dominates price movement influence across all markets and parameters. Retail trading, for instance, seems to have a strong influence over price moves in the KH contract market; retail’s significant contemporaneous impact, short-term persistence, and Granger causality provide considerable evidence for this. This is in contrast to the DJT market, which seems to be more strongly influenced by institutional trading. While this influence is less strong than the influence retail trading has over the KH market, institutional trades still had the greater contemporaneous impact and persistence in this market.

In general, both markets seem to be relatively resilient to price moves from either group; we can see from the Power Law analysis that impact magnitude scales sub-linearly with volume traded. That said, both markets seem to be less resilient to retail trading, and, while retail generally trades in smaller amounts, retail’s additional impact per additional share traded is greater.
