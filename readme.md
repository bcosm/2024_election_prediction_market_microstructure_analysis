...
All CSV data files and supporting code used in this analysis, as well as the paper in .pdf format, are publicly available in the 

[currently open repository.](https://github.com/bcosm/2024_election_betting_market_microstructure_analysis)
